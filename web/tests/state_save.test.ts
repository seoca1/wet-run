...
const mockPrograms: Program[] = [
  { id: "p1", name: "Alpha", tier: 1, cost: 5, effect: "x", description: "", aoe: false },
  { id: "p2", name: "Beta", tier: 1, cost: 5, effect: "x", description: "", aoe: false },
  { id: "p3", name: "Gamma", tier: 1, cost: 5, effect: "x", description: "", aoe: false },
];
