...
ACHIEVEMENTS: dict[str, Achievement] = {
    ...
    "kill_wintermute": Achievement("kill_wintermute", "WINTERMUTE FALLS", "Defeat Wintermute", "combat"),
    "kill_ta_prime": Achievement("kill_ta_prime", "TESSIER FALLS", "Defeat T-A Construct Prime", "combat"),
    "kill_5_wintermute": Achievement("kill_5_wintermute", "WINTERMUTE HUNTER", "Defeat 5 Wintermute variants", "combat"),
    ...
    "no_hit_run": Achievement("no_hit_run", "UNTOUCHABLE", "Complete a run without taking damage", "combat"),
    "no_damage_run": Achievement("no_damage_run", "PERFECT RUN", "Complete a run with 0 HP lost", "combat"),
    "boss_phase_5": Achievement("boss_phase_5", "LAST STAND", "Witness a boss reach Phase 5", "combat"),
    ...
    "boss_no_damage": Achievement("boss_no_damage", "UNTOUCHABLE BOSS", "Defeat a boss without taking damage", "combat"),
    "construct_companion_5": Achievement("construct_companion_5", "BOND", "Use Dixie ally 5 times", "combat"),
    "status_effect_master": Achievement("status_effect_master", "PLAGUE", "Apply all 5 status effects in one run", "combat"),
    ...
    "boss_perfect": Achievement("boss_perfect", "PERFECT BOSS", "Defeat boss without any status effects applied", "combat"),
    # Exploration category (15)
    "all_zones": Achievement("all_zones", "CARTOGRAPHER", "Visit every zone", "exploration"),
    "every_ice": Achievement("every_ice", "BESTIARY", "Encounter 50 unique ICE types", "exploration"),
    ...
    "all_constructs": Achievement("all_constructs", "DIPLOMAT II", "Visit every construct", "exploration"),
    "all_fixes": Achievement("all_fixes", "CONNECTED", "Talk to every fixer", "exploration"),
    "phase_6_visited": Achievement("phase_6_visited", "THE AFTERMATH", "Visit Phase 6 zone", "exploration"),
    "all_mission_archetypes": Achievement("all_mission_archetypes", "VARIETY", "Complete all 4 mission archetypes", "exploration"),
    "all_matrix_events": Achievement("all_matrix_events", "WITNESSED", "Trigger all 6 random matrix events", "exploration"),
    "all_ice_personalities": Achievement("all_ice_personalities", "PSYCHOLOGIST", "Encounter all 4 ICE personalities", "exploration"),
    "dead_drop": Achievement("dead_drop", "DEAD DROP", "Find a hidden data drop", "exploration", hidden=True),
    "ghost_signal": Achievement("ghost_signal", "GHOST", "Receive a ghost signal", "exploration", hidden=True),
    # Meta category (10)
    ...
    "all_mutators": Achievement("all_mutators", "RUNNER", "Complete runs with all 5 mutators", "meta"),
    "all_archetypes": Achievement("all_archetypes", "DIVERSE", "Complete missions of all 4 archetypes", "meta"),
    ...
    "true_ending": Achievement("true_ending", "THE MESSAGE", "Witness the true ending", "story", hidden=True),
}
