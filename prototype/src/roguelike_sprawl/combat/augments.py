...
AUGMENT_REGISTRY: dict[str, WetwareAugment] = {
    ...
    for aug in [
        WetwareAugment(
            "adrenal_boost", "Adrenal Boost", "AP regen +1", "ap_regen", 1.0
        ),
        WetwareAugment(
            "reflex_boost", "Reflex Boost", "Speed +10%", "speed", 0.1
        ),
        WetwareAugment(
            "kerenzikov", "Kerenzikov", "Slow time on combat", "slow_time", 1.0
        ),
        WetwareAugment(
            "sandevistan", "Sandevistan", "Slow time on damage", "slow_time", 1.0
        ),
        WetwareAugment(
            "berserk_core", "Berserk Core", "Crit +10% at low HP", "crit", 0.1
        ),
        WetwareAugment(
            "optical_camo", "Optical Camo", "Dodge +15%", "dodge", 0.15
        ),
        WetwareAugment(
            "pain_editor", "Pain Editor", "Damage threshold -10%", "damage_threshold", -0.1
        ),
        WetwareAugment(
            "bioconductor", "Bioconductor", "Healing +25%", "healing", 0.25
        ),
        WetwareAugment(
            "titanium_bones", "Titanium Bones", "Max HP +20", "max_hp", 20.0
        ),
        WetwareAugment(
            "subdermal_armor", "Subdermal Armor", "Shield +1/hit", "shield_per_hit", 1.0
        ),
        WetwareAugment(
            "gorilla_fists", "Gorilla Fists", "Melee +30%", "melee", 0.3
        ),
        WetwareAugment(
            "projectile_launcher", "Projectile Launcher", "Range +20%", "range", 0.2
        ),
        WetwareAugment(
            "cyberdeck_boost", "Cyberdeck Boost", "AP +2 max", "max_ap", 2.0
        ),
        WetwareAugment(
            "quickhack_boost", "Quickhack Boost", "Hack speed +20%", "hack_speed", 0.2
        ),
        WetwareAugment(
            "stealth_oxide", "Stealth Oxide", "Stealth +25%", "stealth", 0.25
        ),
        WetwareAugment(
            "nanowire", "Nanowire", "Crit +5%", "crit", 0.05
        ),
        WetwareAugment(
            "biowire", "Biowire", "AP regen +2", "ap_regen", 2.0
        ),
        WetwareAugment(
            "missile_launcher", "Missile Launcher", "AoE +20%", "aoe", 0.2
        ),
        WetwareAugment(
            "optical_camouflage", "Optical Camouflage", "Detection -30%", "detection", -0.3
        ),
        WetwareAugment(
            "reinforced_skin", "Reinforced Skin", "Bleed resist", "bleed_resist", 1.0
        ),
        WetwareAugment(
